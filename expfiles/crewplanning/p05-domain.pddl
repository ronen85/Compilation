...
(:types MedicalState FilterState agent PayloadAct Day
...
(:predicates
	...
	(done_sleep ?c - agent ?d - Day)
	(done_pre_sleep ?c - agent ?d - Day)
	(done_post_sleep ?c - agent ?d - Day)
	(done_dpc ?c - agent ?d - Day)
	(done_meal ?c - agent ?d - Day)
	(done_exercise ?c - agent ?d - Day)
