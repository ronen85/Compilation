...
(:durative-action WORK
      ...
      ; pref_start conds are:  [u'(rested ?driver)']
      ; prew_start conds are:  []
      ; pref_inv are:  []
      ; pref_end are:  []
      ...
      ; add start effects are:  [u'(working ?driver)']
      ; del start effects are:  [u'(rested ?driver)', u'(resting ?driver)']
      ; add end effects are:  [u'(tired ?driver)']
      ; del end effects are:  [u'(working ?driver)']

      :effect (and
            (at start (working ?driver))
