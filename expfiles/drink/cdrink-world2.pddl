...
(:durative-action fill-cup-f-start-1
	:parameters (?a - agent ?c - cup)
	:duration (= ?duration 1.0)
	:condition (and (at start (act )) (at start (hold-cup-l ?a ?a ?c)) (at start (isnt-full-l ?a ?c)) (at start (isnt-hold-cup-g ?a ?c)) (over all (act )) (over all (hold-cup-l ?a ?a ?c)) (at end (act )) (at end (hold-cup-l ?a ?a ?c)))
	:effect (and (at start (failure )) (at start (not (isnt-full-l ?a ?c))) (at end (full-l ?a ?c)))
)
(:durative-action fill-cup-f-start-2
	:parameters (?a - agent ?c - cup)
	:duration (= ?duration 1.0)
	:condition (and (at start (act )) (at start (hold-cup-l ?a ?a ?c)) (at start (isnt-full-l ?a ?c)) (at start (full-g ?c)) (over all (act )) (over all (hold-cup-l ?a ?a ?c)) (at end (act )) (at end (hold-cup-l ?a ?a ?c)))
	:effect (and (at start (failure )) (at start (not (isnt-full-l ?a ?c))) (at end (full-l ?a ?c)))
)
