(define (domain cdrink-world)
	(:requirements :typing :negative-preconditions :fluents :durative-actions)
	(:types cup agent)
...
(:action end-person1-s
	...
	:precondition (and 
		(isnt-fin person1) 
		(isnt-thirsty-l person1 person1) 
		(isnt-thirsty-g person1) 
		(on-table-l person1 cup1) 
		(on-table-g cup1))
	:effect (and 
		(fin person1) 
		(not (isnt-fin person1)) 
		(not (act )))
)
(:action end-person2-s
	:parameters ()
	:precondition (and (isnt-fin person2) (isnt-thirsty-l person2 person2) (isnt-thirsty-g person2) (on-table-l person2 cup1) (on-table-g cup1))
	:effect (and (fin person2) (not (isnt-fin person2)) (not (act )))
)
(:action end-person1-isnt-thirsty-f
	:parameters ()
	:precondition (and (isnt-fin person1) (isnt-thirsty-l person1 person1) (on-table-l person1 cup1) (thirsty-g person1))
	:effect (and (failure ) (fin person1) (not (isnt-fin person1)) (not (act )))
)
(:action end-person1-on-table-f
	:parameters ()
	:precondition (and (isnt-fin person1) (isnt-thirsty-l person1 person1) (on-table-l person1 cup1) (isnt-on-table-g cup1))
	:effect (and (failure ) (fin person1) (not (isnt-fin person1)) (not (act )))
)
(:action end-person2-isnt-thirsty-f
	:parameters ()
	:precondition (and (isnt-fin person2) (isnt-thirsty-l person2 person2) (on-table-l person2 cup1) (thirsty-g person2))
	:effect (and (failure ) (fin person2) (not (isnt-fin person2)) (not (act )))
)
(:action end-person2-on-table-f
	:parameters ()
	:precondition (and (isnt-fin person2) (isnt-thirsty-l person2 person2) (on-table-l person2 cup1) (isnt-on-table-g cup1))
	:effect (and (failure ) (fin person2) (not (isnt-fin person2)) (not (act )))
)
...
(:durative-action drink-cup-s
	...
	:effect (and (at start (increase (hold-cup-inv ?a ?c) 1  )) (at start (not (full-l ?a ?c))) (at start (not (full-g ?c))) (at start (not (thirsty-l ?a ?a))) (at start (not (thirsty-g ?a))) (at end (isnt-full-l ?a ?c)) (at end (isnt-full-g ?c)) (at end (isnt-thirsty-l ?a ?a)) (at end (isnt-thirsty-g ?a)) (at end (decrease (hold-cup-inv ?a ?c) 1  )))
)
(:durative-action fill-cup-s
	...
	:effect (and (at start (increase (hold-cup-inv ?a ?c) 1  )) (at start (not (isnt-full-l ?a ?c))) (at start (not (isnt-full-g ?c))) (at end (full-l ?a ?c)) (at end (full-g ?c)) (at end (decrease (hold-cup-inv ?a ?c) 1  )))
)
(:durative-action take-cup-f-start-1
	:parameters (?a - agent ?c - cup)
	:duration (= ?duration 1.0)
	:condition (and (at start (act )) (at start (on-table-l ?a ?c)) (at start (on-table-g ?c)) (at start (clear-l ?a ?a)) (at start (isnt-clear-g ?a)) (over all (act )) (at end (act )))
...
(:durative-action return-cup-f-start-1
	:parameters (?a - agent ?c - cup)
	:duration (= ?duration 1.0)
	:condition (and (at start (act )) (at start (hold-cup-l ?a ?a ?c)) (at start (isnt-full-l ?a ?c)) (at start (isnt-hold-cup-g ?a ?c)) (over all (act )) (at end (act )))
...
(:durative-action return-cup-f-start-2
	:parameters (?a - agent ?c - cup)
	:duration (= ?duration 1.0)
	:condition (and (at start (act )) (at start (hold-cup-l ?a ?a ?c)) (at start (isnt-full-l ?a ?c)) (at start (full-g ?c)) (over all (act )) (at end (act )))
	:effect (and (at start (failure )) (at start (not (hold-cup-l ?a ?a ?c))) (at end (isnt-hold-cup-l ?a ?a ?c)) (at end (on-table-l ?a ?c)) (at end (clear-l ?a ?a)) (at end (not (isnt-on-table-l ?a ?c))) (at end (not (isnt-clear-l ?a ?a))))
)
(:durative-action drink-cup-f-start-1
	:parameters (?a - agent ?c - cup)
	:duration (= ?duration 1.0)
	:condition (and (at start (act )) (at start (hold-cup-l ?a ?a ?c)) (at start (full-l ?a ?c)) (at start (thirsty-l ?a ?a)) (at start (isnt-hold-cup-g ?a ?c)) (over all (act )) (over all (hold-cup-l ?a ?a ?c)) (at end (act )) (at end (hold-cup-l ?a ?a ?c)))
...
(:durative-action drink-cup-f-start-2
	:parameters (?a - agent ?c - cup)
	:duration (= ?duration 1.0)
	:condition (and (at start (act )) (at start (hold-cup-l ?a ?a ?c)) (at start (full-l ?a ?c)) (at start (thirsty-l ?a ?a)) (at start (isnt-full-g ?c)) (over all (act )) (over all (hold-cup-l ?a ?a ?c)) (at end (act )) (at end (hold-cup-l ?a ?a ?c)))
	:effect (and (at start (failure )) (at start (not (full-l ?a ?c))) (at start (not (thirsty-l ?a ?a))) (at end (isnt-full-l ?a ?c)) (at end (isnt-thirsty-l ?a ?a)))
)
(:durative-action drink-cup-f-start-3
	:parameters (?a - agent ?c - cup)
	:duration (= ?duration 1.0)
	:condition (and (at start (act )) (at start (hold-cup-l ?a ?a ?c)) (at start (full-l ?a ?c)) (at start (thirsty-l ?a ?a)) (at start (isnt-thirsty-g ?a)) (over all (act )) (over all (hold-cup-l ?a ?a ?c)) (at end (act )) (at end (hold-cup-l ?a ?a ?c)))
	:effect (and (at start (failure )) (at start (not (full-l ?a ?c))) (at start (not (thirsty-l ?a ?a))) (at end (isnt-full-l ?a ?c)) (at end (isnt-thirsty-l ?a ?a)))
)
(:durative-action fill-cup-f-start-1
	...
	:condition (and 
		(at start (act )) 
		(at start (hold-cup-l ?a ?a ?c)) 
		(at start (isnt-full-l ?a ?c)) 
		(at start (isnt-hold-cup-g ?a ?c)) 
		(over all (act )) 
		(over all (hold-cup-l ?a ?a ?c)) 
		(at end (act )) 
		(at end (hold-cup-l ?a ?a ?c)))
...
(:durative-action fill-cup-f-start-2
	...
	:effect (and 
		(at start (failure )) 
		(at start (ronen-check )) 
		(at start (not (isnt-full-l ?a ?c))) 
		(at end (full-l ?a ?c)))
)
(:durative-action drink-cup-f-end-1
	:parameters (?a - agent ?c - cup)
	:duration (= ?duration 1.0)
	:condition (and (at start (act )) (at start (hold-cup-l ?a ?a ?c)) (at start (hold-cup-g ?a ?c)) (at start (full-l ?a ?c)) (at start (full-g ?c)) (at start (thirsty-l ?a ?a)) (at start (thirsty-g ?a)) (over all (act )) (over all (hold-cup-l ?a ?a ?c)) (over all (hold-cup-g ?a ?c)) (at end (act )) (at end (hold-cup-l ?a ?a ?c)) (at end (isnt-hold-cup-g ?a ?c)))
...
(:durative-action fill-cup-f-end-1
	:parameters (?a - agent ?c - cup)
	:duration (= ?duration 1.0)
	:condition (and (at start (act )) (at start (hold-cup-l ?a ?a ?c)) (at start (hold-cup-g ?a ?c)) (at start (isnt-full-l ?a ?c)) (at start (isnt-full-g ?c)) (over all (act )) (over all (hold-cup-l ?a ?a ?c)) (over all (hold-cup-g ?a ?c)) (at end (act )) (at end (hold-cup-l ?a ?a ?c)) (at end (isnt-hold-cup-g ?a ?c)))
...
(:durative-action take-cup-wait-on-table
	:parameters (?a - agent ?c - cup)
	:duration (= ?duration 1.0)
	:condition (and (at start (act )) (at start (clear-l ?a ?a)) (at start (on-table-l ?a ?c)) (at start (isnt-on-table-g ?c)) (over all (act )) (at end (act )))
